<template>
  <div>
    <div class="cont wow fadeInRight">
      <ul>
        <li v-if="commentsList" v-for="(item,index) in commentsList" :key="index">
          <div class="main-reply">
            <div class="user-info">
              ...
              <div class="more">
                ...
                <p class="submit">
                  <span type="text" class="reply fir-reply shiny" @click="showEditor($event)">回复</span>
                </p>
              </div>
            </div>
            <div v-bind:class="{'editor-reply':true,'hide':true }">
              <form class="form">
                ...
                <div class="submit">
                  <el-button @click="mainSubmit(index,$event)" class="right" size="small">提交回复</el-button>
            ...
            <div class="reply-list" v-for="(replyEntry,replyIndex) in item.children" :key="replyIndex">
              ...
              <div v-bind:class="{'editor-reply':true,'hide':isShow}">
                <form class="form">
                  ...
                  <div class="submit">
                    <el-button @click="replySubmit(index,replyIndex,$event)" class="right" size="small">提交回复</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      // 显示文本编辑器
      showEditor(e) {
        let currentClassName = e.currentTarget.parentElement.parentElement.parentElement.parentElement.lastElementChild
          .className;
        if (
