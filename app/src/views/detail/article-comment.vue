        ...
        <li v-for="(item, index) in commentsList" :key="index">
          <div class="main-reply">
            <div class="user-info">
              ...
              <p class="info">
                <!-- 用户名 -->
                <a href="javascript:void(0)" class="name white">{{
                  item.userName
                }}</a>
              </p>
          ...
          <div class="all-reply">
            <div
              class="reply-list"
              v-for="(replyEntry, replyIndex) in item.children"
              :key="replyIndex"
            >
              <div class="user-info">
                <img
                  :src="replyEntry.userPortrait"
                  alt="头像"
                  class="userImage"
                />
                <p class="info">
                ...
                <div
                  class="comment sec-coment"
                  v-html="replyEntry.content"
                ></div>
                <div class="more">
                  <p class="date">
                    <i class="fa fa-calendar" aria-hidden="true"></i>
              ...
              <div v-bind:class="{ 'editor-reply': true, hide: isShow }">
                <form class="form">
                  ...
                  <div class="submit">
                    <el-button
                      @click="replySubmit(index, replyIndex, $event)"
                      class="right"
                      size="small"
                      >提交回复</el-button
                    >
...
export default {
  ...
  methods: {
    ...
    showEditor(e) {
      ...
      if (currentClassName == "editor-reply hide") {
