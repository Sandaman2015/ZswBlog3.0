      ...
      <div class="video-container">
        <el-col justify="center">
          <div class="content-logo">
            <img src="../../assets/img/index-logo-cut.png">
          </div>
