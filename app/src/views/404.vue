<template>
  <div class="container-404">
    <vue-particles class="particles" color="#fff" :particleOpacity="0.7" :particlesNumber="60" shapeType="circle" :particleSize="4" linesColor="#fff" :linesWidth="0.8" :lineLinked="true" :lineOpacity="0.4" :linesDistance="150" :moveSpeed="2" :hoverEffect="true" hoverMode="grab" :clickEffect="true" clickMode="push" height="100%">
    </vue-particles>
    <div class="text-sign">
      <h3>您需要的页面找不到了</h3>
      <h3>404</h3>
